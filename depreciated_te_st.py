...
class AllTests(unittest.TestCase):
    ...
    def test_user_setup(self):
        new_user = User('Micheal', 'micheal@mherman.org', 'michealherman')
    ...
    def test_invalid_form_data(self):
        self.register('Brandon', 'michael@realpython.com', 'python', 'python')
    ...
    def test_user_registration(self):
        ...
        response = self.register(
            'Micheal', 'micheal@realpython.com', 'python', 'python'
        )
    ...
    def test_users_can_add_tasks(self):
        self.create_user('Micheal', 'micheal@realpython.com', 'python')
